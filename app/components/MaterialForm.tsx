...
export default function MaterialForm() {
    ...
    return(
        <div className="flex gap-4">
            ...
            <input onChange={(e) => setMaterial(e.target.value)} value={material} type="text" name="material" placeholder="cotton" />

            <label>Percentage</label>
            <input onChange={(e) => setPercentage(e.target.value)} value={percentage} type="text" name="percentage" placeholder="86" />
